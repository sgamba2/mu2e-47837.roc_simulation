...
//-----------------------------------------------------------------------------
  if (Figure == 2) {
    ...
    p.hd[0].fNewName       = "RUN105038-data";
    // p.hd[0].fRebin         =  1;
...
//--
    ...
    TFile* f1 = TFile::Open("/exp/mu2e/data/projects/tracker/vst/hist/trkvst.annex.trk_fragment_ana.000281.hist");
    TH1F* h1 = (TH1F *)f1->Get("TrkFragmentAna/trk/frag_0/ch_00/ch_00_nhits");
    ...
    // p.fYMin          = 1.e2;
    //p.fYMax          = 2.e4;
    p.fXAxisTitle    = "Number of hits";
    p.fYAxisTitle    = "counts";
    p.fYTitFormat    = "";
    p.fLabel         = "Number of hits in channel 0, 1st FPGA";
    p.fLabelXMin     = 0.15;
    p.fLabelYMin     = 0.87;
    p.fLegendXMin    = 0.15; p.fLegendXMax = 0.30; p.fLegendYMin = 0.6; p.fLegendYMax = 0.75;
    p.fCanvasName    = Form("Figure_%04i",Figure);
    p.fName          = Form("figure_%05i_nhits_ch00_run281",Figure);
    ...
    p.fLegendXMin    = 0.15; p.fLegendXMax = 0.30; p.fLegendYMin = 0.6; p.fLegendYMax = 0.75;
    p.fCanvasName    = Form("Figure_%04i",Figure);
    p.fName          = Form("figure_%05i_nhits_ch00_run105038",Figure);
    ...
    p.fYAxisTitle    = "counts";
    p.fYTitFormat    = "";
    p.fLabel         = "Occupancy - zoom on last channels";
    p.fLabelXMin     = 0.25;
    p.fLabelYMin     = 0.87;
    p.fLegendXMin    = 0.15; p.fLegendXMax = 0.30; p.fLegendYMin = 0.6; p.fLegendYMax = 0.75;
    p.fCanvasName    = Form("Figure_%04i",Figure);
